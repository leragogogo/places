...
class VisitingScreenBloc
  ...
  void _mapRemoveFavouritePlaceToState(
      RemoveFavouritePlace event, Emitter<VisitingScreenState> emit) {
  ...
  void _mapDragFavouritePlaceToState(
      DragFavouritePlace event, Emitter<VisitingScreenState> emit) {
